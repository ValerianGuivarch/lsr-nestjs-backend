...
export type Schema = {
  ...
  'db_apotheose': {
    plain: {
      'name': string;
      'shortName': string;
      'displayCategory': 'STATS' | 'MAGIE' | 'ARCANES' | 'ARCANES_PRIMES' | 'SOLDATS' | 'PACIFICATEURS' | 'PAROLIERS';
      'description': string;
      'position': number;
      'minLevel': number;
      'maxLevel': number;
  ...
  'db_bloodline_proficiencies_db_proficiency': {
    ...
    flat: {
      ...
      'db_proficiency:displayCategory': 'STATS' | 'MAGIE' | 'ARCANES' | 'ARCANES_PRIMES' | 'SOLDATS' | 'PACIFICATEURS' | 'PAROLIERS';
  ...
  'db_bloodline_skills_db_skill': {
    ...
    flat: {
      ...
      'db_bloodline:display': string;
      'dbSkill:id': number;
      'dbSkill:displayCategory': 'STATS' | 'MAGIE' | 'ARCANES' | 'ARCANES_PRIMES' | 'SOLDATS' | 'PACIFICATEURS' | 'PAROLIERS';
  ...
  'db_character': {
    ...
    flat: {
      ...
      'db_apotheose:displayCategory': 'STATS' | 'MAGIE' | 'ARCANES' | 'ARCANES_PRIMES' | 'SOLDATS' | 'PACIFICATEURS' | 'PAROLIERS';
  ...
  'db_character_apotheoses_db_apotheose': {
    ...
    flat: {
      ...
      'db_character:db_apotheose:displayCategory': 'STATS' | 'MAGIE' | 'ARCANES' | 'ARCANES_PRIMES' | 'SOLDATS' | 'PACIFICATEURS' | 'PAROLIERS';
