...
export type Schema = {
  ...
  'db_bloodline_skill': {
    ...
    flat: {
      ...
      'db_bloodline:name': string;
      'db_bloodline:display': string;
      'db_skill:displayCategory': 'STATS' | 'MAGIE' | 'ARCANES' | 'ARCANES_PRIMES' | 'SOLDATS' | 'PACIFICATEURS';
      ...
      'db_skill:successCalculation': 'AUCUN' | 'SIMPLE' | 'SIMPLE_PLUS_1' | 'DIVISE' | 'DIVISE_PLUS_1' | 'DOUBLE' | 'DOUBLE_PLUS_1' | 'CUSTOM';
  ...
  'db_character_template_skill': {
    ...
    flat: {
      ...
      'db_character_template_through_invocationTemplateName:chairValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_invocationTemplateName:chairValueRule': number;
      'db_character_template_through_invocationTemplateName:espritValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_invocationTemplateName:espritValueRule': number;
      'db_character_template_through_invocationTemplateName:essenceValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_invocationTemplateName:essenceValueRule': number;
      'db_character_template_through_invocationTemplateName:pvMaxValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_invocationTemplateName:pvMaxValueRule': number;
      'db_character_template_through_invocationTemplateName:pfMaxValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_invocationTemplateName:pfMaxValueRule': number;
      'db_character_template_through_invocationTemplateName:ppMaxValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      ...
      'db_character_template_through_characterTemplateName:chairValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_characterTemplateName:chairValueRule': number;
      'db_character_template_through_characterTemplateName:espritValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_characterTemplateName:espritValueRule': number;
      'db_character_template_through_characterTemplateName:essenceValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_characterTemplateName:essenceValueRule': number;
      'db_character_template_through_characterTemplateName:pvMaxValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_characterTemplateName:pvMaxValueRule': number;
      'db_character_template_through_characterTemplateName:pfMaxValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
      'db_character_template_through_characterTemplateName:pfMaxValueRule': number;
      'db_character_template_through_characterTemplateName:ppMaxValueReferential': 'FIXE' | 'CHAIR' | 'ESPRIT' | 'ESSENCE' | 'SUCCESS';
