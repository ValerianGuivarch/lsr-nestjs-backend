...
class ApiPF2PlayerCodex extends ApiBase {
    public function execute() {
        ...
        $this->getResult()->addValue( null, 'pf2playercodex', [ 'characters' => $characters, 'factions' => $factions, 'canEdit' => $this->getUser()->isRegistered() && $this->getUser()->isAllowed( 'delete' ) ? 1 : 0 ] );
    }
