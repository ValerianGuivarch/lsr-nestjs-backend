  ...
  async createFlip(flip: {
    ...
    if (flip.knowledgeName) {
      ...
      return this.flipService.createFlip({
        ...
        flipText:
          ((wizard.displayName !== '' && wizard.displayName != null ? wizard.displayName : wizard.name)
            ? wizard.displayName
            : wizard.name) +
      ...
      this.flipService.createFlip({
        ...
        flipModif: 0,
        flipText:
          (wizard.displayName !== '' && wizard.displayName != null ? wizard.displayName : wizard.name) + ' obtient : ',
