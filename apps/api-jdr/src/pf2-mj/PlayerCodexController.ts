...
export class PlayerCodexController {
  ...
  @Post('characters') createCharacter(@Body() body: { npcId: string; displayName: string; wikiPageTitle: string; wikiPortraitFilename?: string | null }): Promise<unknown> { return this.service.createCharacter(body) }
  @Patch('characters/:npcId') updateCharacter(@Param('npcId') id: string, @Body() body: { displayName?: unknown; wikiPortraitFilename?: unknown }): Promise<unknown> { return this.service.updateCharacter(id, body) }
