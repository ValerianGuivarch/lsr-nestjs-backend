...
export default function App() {
  return (
    <Admin dataProvider={dataProvider} authProvider={authProvider} layout={CustomLayout} title="JdR Admin">
      ...
      <Resource name="characters" options={{ label: 'Personnages' }} list={CharacterList} edit={CharacterEdit} create={CharacterCreate} />
      ...
      <Resource name="resources" options={{ label: 'Ressources' }} list={GameResourceList} edit={GameResourceEdit} create={GameResourceCreate} />
